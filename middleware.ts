...
export const config = {
  matcher: [
     ...
     */
    "/((?!api/|experience-media/|auth/callback|auth/confirm|_next/static|_next/image|favicon\\.ico|manifest\\.webmanifest|sw\\.js|sitemap\\.xml|robots\\.txt|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|mp3|wav|ogg|mp4|webm|txt)$).*)",
  ],
};
