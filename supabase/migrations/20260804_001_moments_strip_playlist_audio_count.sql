-- ============================================
-- Fix audio count in homepage moments strip
--
-- The event_audio_count was counting moments with content_type='audio',
-- but audio files are stored as playlist_tracks via event_playlists,
-- not as moments. This updates the subquery to count playlist tracks.
-- ============================================
