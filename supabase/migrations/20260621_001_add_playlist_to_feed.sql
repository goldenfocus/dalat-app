-- Migration: Add playlist info to feed moments grouped
-- Description: Adds has_playlist field to discovery feed to show playlist button
...
-- Recreate RPC function with has_playlist field
...
COMMENT ON FUNCTION get_feed_moments_grouped IS 'Fetches moments from past events grouped by event for the discovery feed. Orders events by most recent moment activity. Includes has_playlist flag. Used for desktop discovery view.';
