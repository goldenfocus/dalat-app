-- ============================================
-- FIX: Feed Deduplication for Recurring Events
-- Migration: 20260428_001_fix_feed_deduplication
-- ============================================
-- Updates get_events_by_lifecycle_deduplicated to include all current columns
-- that were added after the original function was created.
...
RETURNS TABLE (
  -- All event columns (in order from events table)
  id uuid,
  slug text,
  previous_slugs text[],
  tribe_id uuid,
...
Updated 2026-04-28 to include all current event columns.';
